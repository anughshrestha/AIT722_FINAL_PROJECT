...
##This script creates visualization for the Middle Eastern Restaurants
try:
...
sql = "select * from middle_eastern_restaurant_staged_data"
cursor.execute(sql)
...
#Generate map
m.save('middle-eastern-map.html')
