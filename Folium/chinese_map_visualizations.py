...
##This script creates visualization for the Chinese Restaurants
try:
...
sql = "select * from chinese_restaurant_staged_data"
cursor.execute(sql)
...
for row in restaurant_result:
	...
	#Global tooltip for the datapoints
	tooltip = f"{category}\n"
